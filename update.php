...
?> 
            <form action="updateback.php" method="post">
                <h2><a href="homeAdmin.php"><span>CREATE CAR</span></a>&NonBreakingSpace;<a href="read.php"><span>VIEW FLEET</span></a>&NonBreakingSpace;<a href="update.php"><span style="color: green;">UPDATE FLEET</span></a>&NonBreakingSpace;<a href="delete.php"><span>DELETE CAR</span></a></h2>
                <br><br>
...
if (strpos($fullURL, "signup=emptyInputs")== true) {
    ...
    echo "<p class='mes'>You have successfully updated a vehicle</p>";
    exit();
}
    ?>    
            </form>
